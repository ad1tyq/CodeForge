...
export default function SignOut() {
    ...
    return (
        ...
        <div className="relative group inline-flex">
            <button
                className="bg-white border text-black hover:text-white transition-all duration-200 border-white hover:bg-white/20 p-[0.2rem] px-[1rem] rounded-md cursor-pointer"
                onClick={() => signOut()}
            >
                Sign out
            </button>
